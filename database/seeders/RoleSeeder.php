...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
      $role1 = Role::create(['name' => 'Admin']);
       ...
       Permission::create(['name' => 'admin.posts.index', 'description' => 'Ver publicacions generadas'])->syncRoles([$role1, $role2]);
       Permission::create(['name' => 'admin.posts.create', 'description' => 'Crear Publicación'])->syncRoles([$role1, $role2]);
       Permission::create(['name' => 'admin.posts.edit', 'description' => 'Editar publicacióon'])->syncRoles([$role1, $role2]);
